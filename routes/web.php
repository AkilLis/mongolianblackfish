...
Route::get('/sign-member', function() {
	return view('sign-member');
});


Route::post('/member-ship/request', 'MemberShipController@signUp');

Route::post('/booking/request', 'BookingController@bookginTourDone');
