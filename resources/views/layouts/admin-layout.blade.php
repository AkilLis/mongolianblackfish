...
<html>
<head>
  @include('includes.admin-resource')
</head>
...
<div class="wrapper" id="app">
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>M</b>BF</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Mongolian</b>BlackFish</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="http://www.mongolianblackfish.com/images/logo_white.png" class="img-circle" alt="User Image">
        </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a>Simplood</a>.</strong> All rights
    reserved.
  </footer>
