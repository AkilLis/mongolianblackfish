@extends('layouts.member-layout', ['currentView' => 'index-page'])
@section('content') 
    <div id="scene" style="position: relative;">
        ...
        <div class="container" style="padding-bottom: 80px;">
            <form method="POST" action="/member-ship/request">
                {{ csrf_field() }}
                </br>
                ...
                <div class="col-md-6 col-sm-12 padding-less">
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword1" class="white">Date of birth</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword1" class="white">Gender</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword1" class="white">State</label>
